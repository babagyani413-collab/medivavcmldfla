...
class MediSlot {
    ...
    handleSearch(e) {
        ...
        if (searchTerm) {
            ...
            window.location.href = `doctors.php?search=${encodeURIComponent(searchTerm)}`;
        }
    }
    ...
    updateUserInterface() {
        ...
        const appointmentLinks = document.querySelectorAll('a[href*="user.php"]');
